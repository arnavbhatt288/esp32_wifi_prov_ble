/* Wi-Fi Provisioning through BLE example */
...
static const char *TAG = "ble_wifi_provisioning";
...
/* Try provisioning 5 times */
#define NO_OF_RETRIES           5

/* DO NOT USE THESE VALUES FOR PRODUCTION */
...
/* DO NOT USE THESE FUNCTIONS FOR PRODUCTION */
static esp_err_t example_get_sec2_salt(const char **salt, uint16_t *salt_len) {
    ESP_LOGI(TAG, "Using hard coded salt");
    *salt = sec2_salt;
...
static esp_err_t example_get_sec2_verifier(const char **verifier, uint16_t *verifier_len) {
    ESP_LOGI(TAG, "Using hard coded verifier");
    ...
    if (event_base == WIFI_PROV_EVENT) {
        switch (event_id) {
            ...
            case WIFI_PROV_CRED_FAIL: {
                ...
                /* Retry provisioning for 5 times */
                retries++;
...
void initialize_ble_provisioning(void) {
    ...
    if (!provisioned) {
        ...
        /* The username and password should not be embedded in the firmware,
